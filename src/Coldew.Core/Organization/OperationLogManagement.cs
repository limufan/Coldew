...
namespace Coldew.Core.Organization
{
    public class OperationLogManagement
    {
        ...
        //    orgMnger.UserManager.Created += new TEventHandler<UserManagement, CreatedEventArgs<UserCreateInfo, User>>(UserManager_Created);

        //    orgMnger.PositionManager.Loaded += new TEventHandler<PositionManagement, List<Position>>(this.PositionManager_Loaded);
        //    orgMnger.PositionManager.Created += new TEventHandler<PositionManagement, CreatedEventArgs<PositionCreateInfo, Position>>(PositionManager_Created);
        ...
        //    orgMnger.DepartmentManager.Created += new TEventHandler<DepartmentManagement, CreatedEventArgs<DepartmentCreateInfo, Department>>(DepartmentManager_Created);
        ...
        //    orgMnger.GroupManager.Created += new TEventHandler<GroupManagement, CreatedEventArgs<GroupCreateInfo, Group>>(GroupManager_Created);
        ...
        //    args.ForEach(x =>
        //    {
        //        x.Changed += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Modifyed);
        //        x.Logoffed += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Logoffed);
        //        x.Locked += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Locked);
        //        x.Activated += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Activated);
        //        x.PasswordReseted += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_PasswordReseted);
        //    });
        //}
        ...
        //    user.Changed += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Modifyed);
        //    user.Logoffed += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Logoffed);
        //    user.Locked += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Locked);
        //    user.Activated += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_Activated);
        //    user.PasswordReseted += new TEventHandler<User, ChangeEventArgs<UserChangeInfo, User>>(User_PasswordReseted);
        ...
        //void User_Modifyed(User sender, ChangeEventArgs<UserChangeInfo, User> args)
        //{
        //    OperationLogInfo opInfo = new OperationLogInfo
        //    {
        //        OperationTime = DateTime.Now,
        ...
        //void User_Logoffed(User sender, ChangeEventArgs<UserChangeInfo, User> args)
        //{
        //    OperationLogInfo opInfo = new OperationLogInfo
        //    {
        //        OperationTime = DateTime.Now,
        ...
        //void PositionManager_Created(PositionManagement sender, CreatedEventArgs<PositionCreateInfo, PositionInfo, Position> args)
        //{
        ...
        //void DepartmentManager_Created(DepartmentManagement sender, CreatedEventArgs<DepartmentCreateInfo, DepartmentInfo, Department> args)
        //{
        ...
        //void GroupManager_Created(GroupManagement sender, CreatedEventArgs<GroupCreateInfo, GroupInfo, Group> args)
        //{
