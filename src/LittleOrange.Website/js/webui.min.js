    ...
    horizontalForm: function(){
        this.find(".form-group")
            .each(function(){
                ...
                var labelWidth = $this.find(".control-label").outerWidth();
                $this.find(".control-input").outerWidth(parentWidth - labelWidth);
            });
    }
});
jQuery.extend({
...
(function($){
    $.widget("webui.input", {
            ...
            changed: function(callback){
                var thiz = this;
                this.element.bind((this.widgetEventPrefix + "changed").toLowerCase(), function(event, value){
                    callback(thiz, value);
                });
            },
            inputing: function(callback, delay){
