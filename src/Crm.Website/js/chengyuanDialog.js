(function($){
	        ...
	        _create: function(){
                ...
                this._yonghuGrid.datagrid({
                    columns:[
			            ...
			            {title: "帐号", width: 80, field:"zhanghao"},
			            {title: "姓名", width: 80, field:"xingming"},
			            {title: "部门", width: 120, field:"bumen"}
		            ],
		            canSort: false,
		            singleSelect: true,
		            showNumberRow: false,
    ...
    $.widget("ui.chengyuanPane", {
            ...
            tianjiaYonghu: function(yonghu){
                ...
                var chengyuan = $("<span></span>").chengyuan({ id: yonghu.zhanghao, mingcheng: yonghu.xingming, leixing: chengyuanLeixing.yonghu, removed: function(){
