...
namespace LittleOrange.Core
{
    public class DingdanInitializer
    {
        ...
        public void Initialize()
        {
            ...
            cobject = this._littleOrangeInitializer._coldewManager.ObjectManager.Create(new ColdewObjectCreateInfo("收款管理", "shoukuanGuanli", ColdewObjectType.Standard, true));
